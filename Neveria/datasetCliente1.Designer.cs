...
namespace Neveria {
    ...
    public partial class datasetCliente : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/datasetCliente1.xsd";
        ...
        public partial class ClienteDataTable : global::System.Data.TypedTableBase<ClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ClienteRow AddClienteRow(int Folio, string A_Paterno, string A_Materno, string Nombre) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ClienteRow FindByFolio(int Folio) {
...
namespace Neveria.datasetClienteTableAdapters {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cliente] WHERE (([Folio] = @Original_Folio) AND ([A_Paterno] =" +
                " @Original_A_Paterno) AND ([A_Materno] = @Original_A_Materno) AND ([Nombre] = @O" +
                "riginal_Nombre))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cliente] SET [Folio] = @Folio, [A_Paterno] = @A_Paterno, [A_Materno] = @A_Materno, [Nombre] = @Nombre WHERE (([Folio] = @Original_Folio) AND ([A_Paterno] = @Original_A_Paterno) AND ([A_Materno] = @Original_A_Materno) AND ([Nombre] = @Original_Nombre));
SELECT Folio, A_Paterno, A_Materno, Nombre FROM Cliente WHERE (Folio = @Folio)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Folio, A_Paterno, A_Materno, Nombre FROM dbo.Cliente";
        ...
        public virtual int Delete(int Original_Folio, string Original_A_Paterno, string Original_A_Materno, string Original_Nombre) {
        ...
        public virtual int Update(int Folio, string A_Paterno, string A_Materno, string Nombre, int Original_Folio, string Original_A_Paterno, string Original_A_Materno, string Original_Nombre) {
            ...
            if ((Original_A_Paterno == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_A_Paterno));
            }
            if ((Original_A_Materno == null)) {
                throw new global::System.ArgumentNullException("Original_A_Materno");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_A_Materno));
            }
            if ((Original_Nombre == null)) {
                throw new global::System.ArgumentNullException("Original_Nombre");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string A_Paterno, string A_Materno, string Nombre, int Original_Folio, string Original_A_Paterno, string Original_A_Materno, string Original_Nombre) {
            return this.Update(Original_Folio, A_Paterno, A_Materno, Nombre, Original_Folio, Original_A_Paterno, Original_A_Materno, Original_Nombre);
        }
    }
