...
namespace Neveria.Forms
{
    public partial class Frm_Venta : Form
    {
        ...
        private void btnguardarv_Click(object sender, EventArgs e)
        {
            ...
            System.Data.SqlClient.SqlParameter p = comando.Parameters.AddWithValue("@detalle", spventadetalle.Sp_Detalle_V);
            ...
            {
                spventadetalle.Sp_Detalle_VRow R;
                R = spventadetalle.Sp_Detalle_V.NewSp_Detalle_VRow();
                ...
                spventadetalle.Sp_Detalle_V.AddSp_Detalle_VRow(R);
            }
